...
public class SignatureView3 extends View {
    ...
    public SignatureView3(Context context, AttributeSet attrs) {
        super(context, attrs);
        mMinWidth = convertDpToPx(mMinWidth);
        mMaxWidth = convertDpToPx(mMaxWidth);
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        invalidate(
                (int) (dirtyRect.left - mMaxWidth),
                (int) (dirtyRect.top - mMaxWidth),
                (int) (dirtyRect.right + mMaxWidth),
                (int) (dirtyRect.bottom + mMaxWidth));
